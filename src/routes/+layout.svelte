<script lang="ts">
	...
	const siteTitle = 'Спецтехника | Сургут';
	const metaDescription =
		'Аренда строительной техники в Сургуте: экскаваторы, погрузчики, краны. Почасовая и посуточная аренда. Доставка по ХМАО. Низкие цены.';
</script>
